# Copied from
# https://github.com/google/etils/blob/main/etils/ecolab/lazy_imports.py
"""Common lazy imports.
...
```python
nuco.imports.__all__  # List of modules aliases
nuco.imports.LAZY_MODULES  # Mapping <module_alias>: <lazy_module info>
```
...
def __dir__() -> list[str]:  # pylint: disable=invalid-name
  ...
  to avoid polluting the namespace during auto-completion.
